...
public class DefaultConfig {
    ...
    public static String EXPIRATION_OPTIONS_MSG = "Choose an option";
    public static String EXPIRATION_OPTION_1 = "Option 1";
    public static String EXPIRATION_OPTION_2 = "Option 2";
